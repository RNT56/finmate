...
**Greenfield → in build. Docs complete; backend deployment-ready; M0 foundation + M1 Subscriptions + M2 Income & Expenses (cash-flow metrics) + M3 cost-tracker money-flow + M4 payday calendar built, compiled, and tested on both clients.**
