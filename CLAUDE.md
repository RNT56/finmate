...
**Greenfield → in build. Docs complete; backend deployment-ready; M0 foundation + M1–M5 (Subscriptions, Income & Expenses, money-flow, payday calendar, assets/crypto/multi-currency) built, compiled, and tested on both clients.**
