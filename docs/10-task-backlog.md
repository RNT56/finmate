...
- [~] **M0-AUTH-04** — Implement **email/password** sign-up, sign-in, and password reset against Supabase Auth, with client-side input validation. (dep: M0-AUTH-01) — *sign-in + sign-up shipped with client-side validation on both clients; **password reset** still to add.*
